...
gs = fig.add_gridspec(1, 2, wspace=0.30, left=0.085, right=0.985, top=0.855, bottom=0.145)
...
ax1.text(2.55, 0.935, "canonical\nt=2.5", fontsize=TICK, color="#999", ha="left", va="top")
h, l = ax1.get_legend_handles_labels()
h += [Line2D([], [], marker="*", color="#666", ms=9, lw=0)]
l += ["per-axis CI (Sapozhnikov)"]
ax1.legend(h, l, loc="lower center", fontsize=SECOND, handlelength=1.5,
...
ax2.text(2.55, 0.185, "canonical t=2.5", fontsize=TICK, color="#999", ha="left", va="bottom")
h2, l2 = ax2.get_legend_handles_labels()
h2 += [Line2D([], [], marker="*", color="#666", ms=9, lw=0)]
l2 += ["per-axis CI (Sapozhnikov)"]
ax2.legend(h2, l2, loc="upper center", bbox_to_anchor=(0.5, 1.0), fontsize=SECOND,
...
fig.suptitle("COMAVI benchmark competency (61-variant set; direction-aware "
             ...
             x=0.012, ha="left", va="top", fontsize=BASE, y=0.995,
             fontweight="bold")
